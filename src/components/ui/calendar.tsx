...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        'group/calendar p-2 [--cell-size:--spacing(7)] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent',
